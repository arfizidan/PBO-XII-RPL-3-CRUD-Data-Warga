    ...
    <div id="wrapper">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">                        
                        <a class="collapse-item active" href="form-daftar.php">Tambah Data Warga</a>                        
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <h3 class="text-dark font-weight-bold">Data Warga</h3>
                    </form>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Arfi Zinedine Zidane</span>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center font-weight-bold">Edit Data Warga</h1>
        ...
        <table class="table table-bordered">            
            ...
            <tr>
                ...
                <td> <textarea class="form-control" type="text" name="alamat_lengkap" id="alamat_lengkap" placeholder="Masukkan Alamat Lengkap"><?= $update["alamat_lengkap"]; ?></textarea></td>
            </tr
            <tr>
                <td>Nomor HP</td>
        ...
        <a href="index.php" class="btn btn-success font-weight-bold">Kembali</a>
